/**
 * 标识符:
 * - JavaScript 中变量名、函数名、属性名都属于标识符。
 * - 标识符必须以字母、下划线 (_) 或美元符 ($) 开始，后续字符可以是字母、数字、下划线或美元符
 * - 标识符不能是 ECMAScript 中的关键字或保留字
 * - 通常只使用 ASCII 字母和数字来书写标识符，但 JavaScript 允许标识符中出现 Unicode 字符集中的字母或数字。
 *   所以例如 "var π = 3.14;" 中 π 作为标识符也是合法的。
 */

const Regex = {
  // esprima.js
  AsciiIdentifierStart: /[a-zA-Z\_\$]/, // a-z A-Z _ $
  ...
  AsciiIdentifierPart: /[a-zA-Z0-9\_\$]/, // a-z A-Z 0-9 _ $
...
// forbidden identifiers in strict mode
const StrictForbiddenWord = ["arguments", "eval"];
